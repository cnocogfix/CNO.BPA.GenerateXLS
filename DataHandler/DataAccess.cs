    ...
    public class DataAccess : IDisposable
    {
        ...
        public string getBatchNo()
        {
            try
            {
                ...
                Connect();
                OracleCommand cmd = GenerateCommand("bpa_apps.pkg_batch.get_batch_no", CommandType.StoredProcedure); cmd.BindByName = true;
        ...
        public DataSet getDepartmentDetails()
        {
            try
            {
                ...
                Connect();
                OracleCommand cmd = GenerateCommand("bpa_apps.pkg_ia.select_department", CommandType.StoredProcedure); cmd.BindByName = true;
        ...
        public DataSet getBatchItemDetails()
        {
            try
            {
                ...
                OracleCommand cmd = GenerateCommand("bpa_apps.pkg_ia.select_ia_xls_definition", CommandType.StoredProcedure); cmd.BindByName = true;

                DBUtilities.CreateAndAddParameter("p_in_department_name", BatchDetail.Department, OracleDbType.Varchar2, ParameterDirection.Input, cmd);                
                DBUtilities.CreateAndAddParameter("p_out_result", OracleDbType.Varchar2, ParameterDirection.Output, 255, cmd);
                DBUtilities.CreateAndAddParameter("p_out_error_message", OracleDbType.Varchar2, ParameterDirection.Output, 4000, cmd);
                DBUtilities.CreateAndAddParameter("p_out_ref_cursor", DBNull.Value, OracleDbType.RefCursor, ParameterDirection.Output, cmd);
